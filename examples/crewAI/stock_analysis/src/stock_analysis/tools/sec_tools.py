...
class FixedSEC10KToolSchema(BaseModel):
    ...
    # Add ConfigDict for Pydantic V2 compatibility
...
class SEC10KTool(RagTool):
    ...
    def _run(self, search_query: str = None, query: str = None, **kwargs: Any) -> Any:
        # Handle both parameter naming conventions
        final_query = search_query or query
        if not final_query:
            return "Error: No search query provided"
        return super()._run(query=final_query, **kwargs)
